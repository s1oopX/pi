...
- Built-in: `dark`, `light`, `pi-studio-dark`, `pi-studio-light`
...
- [pi-studio-dark.json](../src/modes/interactive/theme/pi-studio-dark.json)
- [pi-studio-light.json](../src/modes/interactive/theme/pi-studio-light.json)
