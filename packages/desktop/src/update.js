...
function validateReleaseUrl(value) {
	...
	if (url.protocol !== "https:" || url.hostname !== "github.com" || !url.pathname.startsWith(RELEASE_PAGE_PREFIX)) {
...
export async function checkDesktopUpdate(currentVersion, options = {}) {
	...
	const latestVersion = typeof release.tag_name === "string" ? release.tag_name.trim().replace(/^v/, "") : "";
